...
def add_motion_artefacts(dataset, motion_artefact_coefficient=0.99, 
    ...
    if prob <= motion_artefact_coefficient * 100:
        ...
        sample_kspace = dataset[1][0]                            # HARDCODED DATA INPUT
        ...
        if direction == 'left' or direction == 'right':
            sample_kspace = dataset[200][0]                        # HARDCODED DATA INPUT
            ...
            test_kspace = dataset[0][0]                                                  # HARDCODED DATA INPUT
            kspace_list = [dataset[i+5][0] for i in range(num_of_slices_per_artifact)]    # HARDCODED DATA INPUT
...
def main():
    dir_train = '/home/ekuzmina/DnCNN2/singlecoil_train.h5'
    dataset = FastMRIh5Dataset(dir_train, FastMRITransform(RandomMaskFunc([0.08], [1])))
    kspace = add_motion_artefacts(dataset, num_of_slices_per_artifact = 5) # num_of_slices_per_artifact WHAT NUMBER TO CHOOSE?
